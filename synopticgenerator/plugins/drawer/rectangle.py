...
class Drawer(ObjectDrawer):
    ...
    def drawrect(self, canvas, bound, color, thickness, linetype=4, shift=0):
        ...
        if color.has_alpha:
            ...
            cv2.rectangle(
                tmp, b1, b2, color.get_gbr(), thickness, linetype, shift)
            ...
            cv2.rectangle(
                canvas, b1, b2, color.get_gbr(), thickness, linetype, shift)
            return canvas
    ...
    def draw(self, image, bound, color):
        ...
        return self.drawrect(image, bound, color, self.thickness, 2)
